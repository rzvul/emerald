...
#define MINIOR_CORE_SPECIES_INFO(Form, color, iconPal)          \
    ...
    [SPECIES_MINIOR_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = { EGG_GROUP_MINERAL, EGG_GROUP_MINERAL },
        .abilities = { ABILITY_MOLD_BREAKER, ABILITY_MOLD_BREAKER, ABILITY_MOLD_BREAKER }, // Placeholder ability
        ...
        PALETTES(MiniorMega),
        ICON(MiniorMeteor, 0),           // Al doilea parametru este indexul paletei pentru iconiță
        .footprint = gMonFootprint_Minior,
        LEARNSETS(Minior),
        .formSpeciesIdTable = sMiniorFormSpeciesIdTable,
